# Contributing to @plasius/dungeon-crafting
...
`@plasius/dungeon-crafting` provides DIS-gated dungeon-crafting and chaos-sealing authority contracts for Plasius.

Contributions typically fall into dungeon-authority contracts, chaos-hotspot metadata, eligibility helpers, docs, tests, and tooling quality.
